...
public class DesignDriver {
	...
	public static void drawString(Graphics2D brush, String text, int x, int y) {
		for (String line : text.split("\n")) // splits the text by \n, new line character 
			brush.drawString(line, x, y += brush.getFontMetrics().getHeight());	// uses Graphics2D drawString and changes the y value by adding the height of each of lines
	}
